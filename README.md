...
- [X] Proper error messages when register fails
- [X] Geofencing: Figure out how the map UI will work
- [ ] Parent dashboard
...
- [X] Proper error message when register fails
...
- [X] Enable the school admin to add boundaries
#### Watch App API
